        ...
        document.getElementById('predictionForm').addEventListener('submit', async (e) => {
            ...
            try {
                ...
                if (result.success) {
                    ...
                    let advice = '✅ <strong>Predicted In-Hospital Mortality risk is relatively low</strong><br><br>';
                    ...
                    if (riskScore >= 0.7) {
                        levelClass = 'high';
                        levelText = '🔴 High Risk';
                        advice = '❌ <strong>Predicted In-Hospital Mortality risk is high</strong><br><br>';
                        ...
                        advice = '⚠️ <strong>Predicted In-Hospital Mortality risk is moderate</strong><br><br>';
